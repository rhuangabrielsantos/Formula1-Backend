...
class View
{
    ...
    public static function descNewCar(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . " \e[00;33m- php executarComando adicionarCarro [Piloto] [Marca] [Modelo] [Cor] [Ano]\e[00;37m" . PHP_EOL;
    }
    ...
    public static function descSetPosition(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . "\e[00;31mComo usar:" . PHP_EOL
            . " \e[00;33m- php executarComando definirPosicoes\e[00;37m" . PHP_EOL;
    }
    ...
    public static function descShowCars(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . "\e[00;31mComo usar:" . PHP_EOL
            . " \e[00;33m- php executarComando exibirCarros\e[00;37m" . PHP_EOL;
    }
    ...
    public static function descStartRace(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . "\e[00;31mComo usar:" . PHP_EOL
            . " \e[00;33m- php executarComando iniciarCorrida\e[00;37m" . PHP_EOL;
    }
    ...
    public static function descFinishRace(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . "\e[00;31mComo usar:" . PHP_EOL
            . " \e[00;33m- php executarComando finalizarCorrida\e[00;37m" . PHP_EOL;
    }
    ...
    public static function descOvertake(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . "\e[00;31mComo usar:" . PHP_EOL
            . " \e[00;33m- php executarComando ultrapassar (Piloto)\e[00;37m" . PHP_EOL;
    }
    ...
    public static function descDeleteCar(): void
    {
        echo "\e[00;31mDescricao:" . PHP_EOL
            ...
            . "\e[00;31mComo usar:" . PHP_EOL
            . " \e[00;33m- php executarComando excluirCarro Piloto\e[00;37m" . PHP_EOL;
    }
